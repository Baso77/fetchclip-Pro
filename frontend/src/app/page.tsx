...
import { Shield, Zap, Globe, Lock, Star, CheckCircle } from 'lucide-react';

export const metadata: Metadata = {
  title: 'FetchClip Pro — Free Video Downloader for YouTube, TikTok, Instagram & More',
  description: 'Download videos in HD from YouTube, TikTok, Instagram, Facebook, Twitter/X and Pinterest. Free, no signup, instant browser download.',
};

const PLATFORMS = [
  { name: 'YouTube', icon: '▶️', color: 'from-red-500 to-red-600', path: '/tools/youtube-downloader' },
  { name: 'TikTok', icon: '🎵', color: 'from-gray-900 to-gray-700', path: '/tools/tiktok-downloader' },
  { name: 'Instagram', icon: '📸', color: 'from-pink-500 to-purple-600', path: '/tools/instagram-downloader' },
  { name: 'Twitter/X', icon: '𝕏', color: 'from-sky-500 to-sky-600', path: '/tools/twitter-downloader' },
  { name: 'Facebook', icon: 'f', color: 'from-blue-600 to-blue-700', path: '/tools/facebook-downloader' },
  { name: 'Pinterest', icon: '𝐏', color: 'from-red-600 to-red-700', path: '/tools/pinterest-downloader' },
];
...
const FEATURES = [
  ...
  { icon: Globe, title: '6 Platforms', desc: 'YouTube, TikTok, Instagram, Facebook, Twitter/X and Pinterest.' },
...
const FAQS = [
  ...
  { q: 'What video quality can I download?', a: 'We offer all available qualities up to 4K for YouTube and highest available for other platforms.' },
  { q: 'Can I download audio only?', a: 'Yes! Every video has an "Audio Only" button that extracts just the audio track in M4A or MP3 format.' },
  ...
  { q: 'Do you support Instagram Reels and Stories?', a: 'Yes! Paste the public Instagram Reel or post URL and we will fetch it. Stories are private and cannot be downloaded.' },
];
        ...
        <section className="relative pt-28 pb-20 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto mb-12 leading-relaxed">
              Paste a URL from YouTube, TikTok, Instagram, Facebook, Twitter or Pinterest.
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
              {[
                ...
                { step: '3', title: 'Download', desc: 'Choose quality and click Download — instant browser download' },
              ].map(s => (
