...
function detectPlatform(url) {
  try {
    ...
    if (['youtube.com', 'youtu.be', 'm.youtube.com'].includes(clean)) return 'youtube';
...
module.exports = { urlSchema, detectPlatform, isSupportedUrl, sanitizeUrl, SUPPORTED_DOMAINS };
